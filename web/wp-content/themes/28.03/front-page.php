...
$hero_video = ou('ou_video','');
$discs = array_filter([
    ou('ou_disc1','Web Design'),
    ou('ou_disc2','Video'),
    ou('ou_disc3','Photography'),
    ou('ou_disc4','Graphic Design'),
]);
  ...
  <div class="about__grid">
    ...
    <div class="about__body">
      <p class="about__text" data-reveal="up" data-delay="1">
        <?php echo esc_html(ou('ou_about_text',
  ...
  <div class="contact__inner">
    ...
    <div class="contact__grid">
      ...
      <p class="contact__text" data-reveal="up" data-delay="1">
        <?php echo esc_html(ou('ou_contact_t',
      ...
      <div class="contact__links" data-reveal="up" data-delay="2">
        <?php $email = ou('ou_email','hello@yoursite.com'); ?>
